    ...
    render() {
        return (
            ...
            <div class="ui labeled input" style={{ 'margin-left': '20px' }}>
                <div class="ui label" style={{ background: 'rgb(83, 224, 218)', 'border-radius': '5px' }}>
                    {this.props.labelDinamico}
                </div>
                <input type="text" placeholder="Contacto, Diseño o Investigación" key={this.props.keyDinamico}
