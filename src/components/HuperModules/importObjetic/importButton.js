                ...
                trigger={
                    <div>
                        <nav className="menus" style={{
                            ...
                            <a href="#" onClick={() => { this.renderActivitisTrello() }} className={`menus-item ${tpTrello}`}> <Image src={trello} size="mini" style={{ top: '20px', left: '22px', transform: 'rotate(-90deg)', filter: 'grayscale(' + tpTrelloImg + ')' }}></Image> </a>
                            <a href="#" onClick={() => { this.renderActivitisAsana() }} className={`menus-item ${tpasana}`}> <Image src={asana} size="mini" style={{ top: '20px', left: '22px',  transform: 'rotate(-90deg)', filter: 'grayscale(' + tpasanaImg + ')' }}></Image> </a>
                            <a href="#" className="menus-item gray"> <Image src={googleSheet} size="mini" style={{ top: '20px', left: '22px',  transform: 'rotate(-90deg)', filter: 'grayscale(1)' }}></Image> </a>
                            <a href="#" className="menus-item gray"> <Image src={clickup} size="mini" style={{ top: '20px', left: '22px', transform: 'rotate(-90deg)', filter: 'grayscale(1)' }}></Image></a>
